    ...
    createClass(Instance, [
      {
        ...
        value: function setNextStringDelay() {
          ...
          this.options.nextStringDelay = {
            ...
            total: isArray
              ? this.options.nextStringDelay.reduce(function (
                  accumulator,
                  currentValue
                ) {
        ...
        value: function _delete() {
          ...
          this.timeouts[1] = setTimeout(function () {
            ...
            if (_this6.elementContainer.innerHTML.indexOf("></") > -1) {
              for (
                var i = _this6.elementContainer.innerHTML.indexOf("></") - 2;
                i >= 0;
                i--
              ) {
                if (textArray[i] === "<") {
            ...
            //-- tag we want to keep.
            _this6.elementContainer.innerHTML = textArray
              .join("")
              .replace(/<[^\/>][^>]*><\/[^>]+>/, "");
